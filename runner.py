from synthesis.stm_synthesiser import *
from spec.spec_builder import get_spec
from viz.parse_graph import render_parse_graph
from backend.field_restorer import table_to_states, assign_extractions
from backend.drop_and_stitch import (enumerate_paths,
                         stitch_back, build_straight_line_states, render_states)
from backend.p4_generator import emit_p4
import argparse
import time
import sys
import contextlib
